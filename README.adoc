...
This iteration is more of optimizing the https://redhat-developer-docs.github.io/green-cloud-demo/#iteration-2[Iteration-II] on OpenShift. This iteration has fair bit of code change that is required to port the application to
use:
